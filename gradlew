...
#           ksh Gradle
#
#       Busybox and similar reduced functionality shells and editors
#       are NOT supported.
#
#   (2) You need a Java installation to run Gradle. If JAVA_HOME is set, it
#       will be used. Otherwise, java from PATH will be used.
#
#   (3) This script was generated by Gradle. Do not modify it directly.
#       Instead, you can use Gradle's `wrapper` task to regenerate.
#
##############################################################################
